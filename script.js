...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Expand selector to include paragraphs in the button container
  const preloaderTexts = document.querySelectorAll(".preloader p, .preloader-btn-container p");
  ...
  introTl
    ...
    .to(
      ...
      "-=0.75", // Start at the same time as the label appears
    )
    .to(
      "#pbc-label .line",
      {
    ...
    exitTl
      ...
      .to(
        preloaderBtn,
        {
          ...
          ease: "power2.inOut",
          onComplete: () => {
            gsap.set(preloaderBtn, { display: "none" });
          },
        },
        "-=1.25",
      );
